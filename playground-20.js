...
function hotelSystem(rooms) {
    ...
    return {
        searchReservation(id) {
            const a = reservations.find(obj => obj.id === id);
        ...
        getSortReservations() {
            const reservationsSorted = reservations.map((reservation) => ({
                ...reservation,
                checkIn: new Date(reservation.checkIn),
            }))
            .sort((a, b) => a.checkIn - b.checkIn);
            console.log(reservationsSorted);
        },
        ...
        removeReservation(id) {
            const index = reservations.findIndex(obj => obj.id === id);
